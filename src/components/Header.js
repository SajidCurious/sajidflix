  ...
  return (
    <header class="body-font bg-[#222f3e] text-white w-full ">
      <div class="container mx-auto flex flex-wrap p-4 flex-col md:flex-row items-center w-full">
        ...
        <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center list-none font-semibold space-x-10">
          <li>
          ...
          <li>
            <Link href="/about" className=" hover:text-blue-200 cursor-pointer">
              About
            </Link>
          </li>
          <li>
